...
import com.example.chozabredtttttttto.urok1_1.EndActivity1_1;
import com.google.android.material.bottomsheet.BottomSheetDialog;

public class test1_3 extends AppCompatActivity {
    ...
    private final String[][] questions = {
            {"0", " Comment ça va", "Comment ça va", "Comant ça va"},                       // Правописание
            {"1", "Ça ne va pas", "Так себе", "Плохо"},         // Перевод
            {"0", "Comme ci", "Comme ci", "Comme si"},                 // Правописание
            {"1", "Ça va bien", "Всё хорошо", "Плохо"},    // Перевод
            {"2", "bonjour", "Ça ne va pas", "Ça va bien"},               // Аудио вопрос 1
            {"2", "merci", "Et toi?", "Comment ça va?"}, // Аудио вопрос 2
            {"3", "А ты? | Как дела?", "А ты? | Как дела?", "Comment ça va?|Et toi?"}, // Перенос слов 1
            {"3", "Так себе | Всё хорошо", "Так себе | Всё хорошо", "Ça va bien|Comme ci, comme ça "} // Перенос слов 2
    };
    ...
    private void showBottomSheetDialog(boolean isCorrect) {
        ...
        nextQuestionButton.setOnClickListener(v -> {
            ...
            if (currentQuestion < questions.length) {
                ...
                Intent intent = new Intent(this, EndActivity1_3.class);
