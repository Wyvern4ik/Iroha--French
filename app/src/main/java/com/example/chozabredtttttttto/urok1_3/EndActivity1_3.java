...
public class EndActivity1_3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_end1_3);
        ...
        retryButton.setOnClickListener(v -> {
            Intent retryIntent = new Intent(this, teoria1_3.class); // Переход на основной экран
