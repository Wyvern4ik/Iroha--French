...
public class EndActivity1_1 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_end1_1);
        ...
        retryButton.setOnClickListener(v -> {
            Intent retryIntent = new Intent(this, teoria1_1.class); // Переход на основной экран
