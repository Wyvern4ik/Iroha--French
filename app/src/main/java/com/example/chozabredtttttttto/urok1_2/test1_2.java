...
public class test1_2 extends AppCompatActivity {
    ...
    private final String[][] questions = {
            {"0", "Merci", "Merci", "Mersi"},                       // Правописание
            {"1", "Excusez-moi", "Простите", "Пожалуйста"},         // Перевод
            {"0", "De rien", "De rien", "De reen"},                 // Правописание
            {"1", "S’il vous plaît", "Пожалуйста", "Не за что"},    // Перевод
            {"2", "bonjour", "Pardon", "Excusez-moi"},               // Аудио вопрос 1
            {"2", "merci", "S'il vous plaît", "De rien"}, // Аудио вопрос 2
            {"3", "Не за что | Спасибо", "Не за что | Спасибо  ", "Merci|De rien"}, // Перенос слов 1
            {"3", "Пожалуйста | Извините", "Пожалуйста | Извините", "Pardon|S'il vous plaît"} // Перенос слов 2
    };
    ...
    private void showBottomSheetDialog(boolean isCorrect) {
        ...
        nextQuestionButton.setOnClickListener(v -> {
            ...
            if (currentQuestion < questions.length) {
                ...
                Intent intent = new Intent(this, EndActivity1_2.class);
