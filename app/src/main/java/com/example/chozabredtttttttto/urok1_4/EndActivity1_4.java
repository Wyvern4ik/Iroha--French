...
public class EndActivity1_4 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_end1_4);
        ...
        retryButton.setOnClickListener(v -> {
            Intent retryIntent = new Intent(this, teoria1_4.class); // Переход на основной экран
