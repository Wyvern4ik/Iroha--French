...
import com.example.chozabredtttttttto.urok1_3.EndActivity1_3;
import com.google.android.material.bottomsheet.BottomSheetDialog;

public class test1_4 extends AppCompatActivity {
    ...
    private final String[][] questions = {
            {"0", "Frère", "Frère", "Frer"},                       // Правописание
            {"1", "Sœur", "Сестра", "Мама"},         // Перевод
            {"0", "Mère", "Mère", "Mere"},                 // Правописание
            {"1", "Ça va bien", "Ребёнок", "Брат"},    // Перевод
            {"2", "bonjour", "Папа", "Брат"},               // Аудио вопрос 1
            {"2", "merci", "Брат", "Мама"}, // Аудио вопрос 2
            {"3", "Брат | Мама", "Брат | Мама", "Mère|Frère"}, // Перенос слов 1
            {"3", "Ребёнок | Сестра", "Ребёнок | Сестра", "Sœur|Enfant  "} // Перенос слов 2
    };

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_test1_4);
    ...
    private void showBottomSheetDialog(boolean isCorrect) {
        ...
        nextQuestionButton.setOnClickListener(v -> {
            ...
            if (currentQuestion < questions.length) {
                ...
                Intent intent = new Intent(this, EndActivity1_4.class);
